...
using System.ComponentModel.DataAnnotations; //para que el required [funcione]
...
namespace Abstracciones.Modelos
{
    public class VehiculoBase
    {
        ...
        [StringLength(40, ErrorMessage = "La propiedad color deber ser mayor a 4 caracteres y menos a 40", MinimumLength = 4)]
